...
class CNN_ViT_meta(nn.Module):
    def __init__(self, img_size=1024, patch_size=16, in_channels=1, num_classes=2,
        ...
        # 调整后的图像大小
        self.img_size_after_cnn = img_size // 8
...
class MobilenetV2(nn.Module):
    def __init__(self, num_classes=2):
        ...
        # 替换分类器中的最后一个线性层
        # MobileNetV2的分类器是一个Sequential, 最后一层是线性层
        num_ftrs = mobilenet_model.classifier[1].in_features # 获取输入维度
        mobilenet_model.classifier[1] = nn.Linear(num_ftrs, num_classes) # 替换
